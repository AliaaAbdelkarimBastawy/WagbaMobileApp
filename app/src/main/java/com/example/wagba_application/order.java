...
public class order extends Fragment {
    ...
    DatabaseReference ref = database.getReference(FirebaseAuth.getInstance().getCurrentUser()
            .getUid()+"/Orders");
...
//        dataInitialize();
        ...
        OrderHistoryAdapter myAdapter = new OrderHistoryAdapter(getContext(), OrderList);
